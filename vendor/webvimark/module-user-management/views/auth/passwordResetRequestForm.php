...
$this->title = Yii::t("app","Şifrənin bərpası");
...
<div class="custom-modal-size ">
    ...
    <div class="site-request-password-reset" >
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <?= Html::submitButton(Yii::t('app','Göndər'), ['class' => 'btn btn-fill-out btn-block','style'=>'margin-top: 25px;padding: 6px;']) ?>
            </div>
                <?php ActiveForm::end(); ?>
        </div>
    </div>
...
var form = $("form#request-password-reset-form");
