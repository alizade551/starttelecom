...
class UserSearch extends User
{
	public function rules()
	{
		return [
			...
			[['username', 'gridRoleSearch', 'registration_ip', 'email','personal','auth_key','api_access'], 'string'],
		];
	}
	...
	public function search($params)
	{
		...
		$dataProvider = new ActiveDataProvider([
			'query' => $query,
			'pagination' => [
				'pageSize' => Yii::$app->request->cookies->getValue('_grid_page_size_users', 20),
			]
		]);
		...
		$query->andFilterWhere([
			...
			->andFilterWhere(['like', 'personal', $this->personal])
			->andFilterWhere(['like', 'api_access', $this->api_access])
