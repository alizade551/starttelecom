...
abstract class AbstractItemSearch extends AbstractItem
{
	...
	public function search($params)
	{
		...
		$grid_page_size_name = ( static::ITEM_TYPE == static::TYPE_ROLE ) ? '_grid_page_size_role' : '_grid_page_size_permission';

		$dataProvider = new ActiveDataProvider([
			'query' => $query,
			'pagination' => [
				'pageSize' => \Yii::$app->request->cookies->getValue( $grid_page_size_name, 20 ),
			],
			'sort'=>[
				'defaultOrder'=>[
