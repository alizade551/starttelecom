...
<?php if (file_exists(Yii::getAlias("@app").'/messages/'.$model->alias.'/app.php')):
$file = include_once(Yii::getAlias("@app").'/messages/'.$model->alias.'/app.php');
 ?>
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><span><a href="/language/index"><?=Yii::t("app","Languages") ?></a></span></li>
        <li class="breadcrumb-item active" aria-current="page"><span><?=$this->title ?></span></li>
    </ol>
</nav>

<div class="row">
	 <div class="col-xl-12 col-lg-12 col-md-12 col-12" style="padding-bottom:0">
						...
						<?php if ($file): ?>
							<?php foreach ($file as $key => $value): ?>
								<div class="form-group">
									<label><?=$key?></label>
									<textarea class="form-control"  name="lang[<?=$key?>]"><?=$value?></textarea>
								</div>
							<?php endforeach ?>
						<?php endif ?>
					<div class="form-group">
