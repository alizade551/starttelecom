    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group field-userdamages-member_fullname required">
                <label for="userdamages-member_fullname"><?=Yii::t("app","User") ?></label>
        ...
        <div class="col-sm-6">
            <div class="form-group field-userdamages-damage_reason required">
                ...
                <input type="text" id="userdamages-damage_reason" class="form-control"  value="<?=\app\models\UserDamages::getDamageReason()[$model->damage_reason]  ?>" aria-required="true" disabled>
                <div class="invalid-feedback"></div>
            </div>
        </div>
