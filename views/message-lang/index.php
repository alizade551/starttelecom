...
$this->title = Yii::t('app', 'Message languages');
...
$pageSize = GridPageSize::widget([
    'pjaxId'=>'pjax-message-lang',
    'pageName'=>'_grid_page_size_message_lang'
]);
...
<div class="widget widget-content-area mb-3">
    <div class="widget-one">
        <div class="actions-container" style="display: flex; justify-content: space-between;">
            ...
            <?php if ( User::canRoute(["/message-lang/create"]) ): ?>
               <a class="btn btn-success modal-d" data-pjax="0" href="<?=$langUrl ?>/message-lang/create" title=" <?=Yii::t("app","Create a message language") ?>">
                ...
                <?=Yii::t("app","Create a message language") ?>
               </a>
            <?php endif ?>
        </div>
    </div>
...
<div class="card custom-card">
    <div class="row">
         <div class="col-sm-12">
            <?php Pjax::begin(['id'=>'pjax-message-lang']); ?>
                <?= GridView::widget([
                    'id'=>'message-lang-grid',
                    ...
                    'columns' => [
                         [
                            ...
                            'visible'=>User::hasPermission("message-lang-serial-column-view"),
                        ...
                        [
                            'attribute'=>'name',
                            'visible'=>User::hasPermission("message-lang-name-view"),
                            'headerOptions'=>['style'=>'width:35%;text-align:center;'],
                            'contentOptions'=>['style'=>'width:35%;text-align:center;'],
                        ...
                        [
                            'attribute'=>'alias',
                            'visible'=>User::hasPermission("message-lang-alias-view"),
                        ...
                        [
                            'attribute'=>'published',
                            'visible'=>User::hasPermission("message-lang-published-view"),
                            'format'=>'raw',
                    ...
                    [
                        ...
                        'visible'=>User::canRoute(["/message-lang/update"]),
                            ...
                            'buttons'=>[
                                'update'=>function($url,$model){
                                    return Html::a('<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-feather"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"></path><line x1="16" y1="8" x2="2" y2="22"></line><line x1="17.5" y1="15" x2="9" y2="15"></line></svg>',$url,[
                                        'data'=>['pjax'=>0],'class'=>'modal-d','title'=>Yii::t('app', 'Update message language: {language}!', ['language' => $model->name])
                                    ]); 
                                 }
                            ]
                    ],
                    ...
                    [
                        'class' => 'yii\grid\ActionColumn',
                        'visible'=>User::canRoute(["/message-lang/delete"]),
...
<style type="text/css">
   .message-lang-index{width: 100%;padding: 0 15px} 
</style>
<?php 
Modal::begin([
    'title' => Yii::t('app','Message language'),
    'id' => 'modal',
    'options' => [
...
$this->registerJs('
  $(document).on("click",".alertify-confirm",function(){
      ...
      var message  = "'.Yii::t("app","Are you sure want to delete this ?").'";
                   ...
                   success:function(response){
                        if(response.status == "success"){
                            that.closest("tr").fadeOut("slow");
                             ...
                             alertify.success("'.Yii::t("app","Message language was deleted successfuly").'");
                        }else{
                             alertify.set("notifier","position", "top-right");
        ...
        }).set({title:"'.Yii::t("app","Delete a message language").'"}).set("labels", {ok:"'.Yii::t('app','Confrim').'", cancel:"'.Yii::t('app','Cancel').'"});   
        return false;
    });
