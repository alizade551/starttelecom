...
$this->title = Yii::t('app', 'Sloved reports');
...
if ( isset( Yii::$app->request->cookies->get( Yii::$app->controller->id.'GridViewVisibility')->value )) {
    ...
    $gridViewVisibility["reason-view"] = "true@Reported result";
    ...
    $viewVisibility = \app\widgets\gridViewVisibility\viewVisibility::widget(
        [
            ...
            'url'=>Url::to('/user-damages/grid-view-visibility'),
            'pjaxContainer'=>'#reports-grid-pjax'
        ]
    );

    $pageSize = GridPageSize::widget([
        'pjaxId'=>'reports-grid-pjax',
        'pageName'=>'_grid_page_size_sloved_reports'
    ]);
...
<div class="widget widget-content-area mb-3">
    <div class="widget-one">
        <div class="actions-container" style="display: flex; justify-content: space-between;">
            ...
            <?php if (User::canRoute("/user-damages/create")): ?>
                <a class="btn btn-success add-element" data-pjax="0" href="/user-damages/create" title=" <?=Yii::t("app","Create a report") ?>">
...
<div class="user-reports-index card custom-card ">
    <div class="row">
        <div class="col-sm-12">
            <?php Pjax::begin(['id'=>'reports-grid-pjax']); ?>
                <?= GridView::widget([
                        'id'=>'reports-grid',
                        ...
                        'columns' => [
                            [
                                ...
                                'visible'=> ( str_contains( $gridViewVisibility["serial-view"], 'true' ) == "true" && User::hasPermission("report-serial-column-view") ) ? true : false,
                            ...
                            [
                                'attribute'=>'fullname',
                                'visible'=> (  str_contains( $gridViewVisibility["customer-view"], 'true' )  == "true" && User::hasPermission("report-customer-fullname-view") ) ? true : false,
                            ...
                            [
                                ...
                                'visible'=> (  str_contains( $gridViewVisibility["user-view"] , 'true' ) == "true" && User::hasPermission("report-user-view") ) ? true : false,
                            ...
                            [
                                'attribute'=>'personal',    
                                'visible'=> ( str_contains( $gridViewVisibility["personal-view"], 'true' )  == "true" && User::hasPermission("report-personal-view") ) ? true : false,
                                ...
                                'value'=>function ($model){
                                    ...
                                    foreach ($model->damagePersonals as $key => $member) {
                                        if ($model->status == 1) {
                                            $badges .= ' <span class="badge badge-pills badge-success" style="margin-bottom:5px">'.$member->personal->fullname.'</span>';

                                        }else{
                                            $badges .= ' <span class="badge badge-pills badge-warning" style="margin-bottom:5px">'.$member->personal->fullname.'</span>';
                                        }
                            ...
                            [
                                ...
                                'visible'=> ( str_contains( $gridViewVisibility["report-view"], 'true' ) == "true" && User::hasPermission("report-reason-view") ) ? true : false,
                                'format'=>'raw',
                                'options'=>['style'=>'width:10%;text-align:center;'],
                                'headerOptions' => ['style' => 'width:10%;text-align:center;'],
                                'contentOptions' => ['style' => 'width:10%;text-align:center;'],
                            ...
                            [
                                'attribute'=>'message',
                                'visible'=> ( str_contains( $gridViewVisibility["report-message-view"], 'true' ) == "true" && User::hasPermission("report-message-view") ) ? true : false,
                                'format'=>'raw',
                                'options'=>['style'=>'width:10%;text-align:center;'],
                                'headerOptions' => ['style' => 'width:10%;text-align:center;'],
                                'contentOptions' => ['style' => 'width:10%;text-align:center;'],
                            ...
                            [
                                ...
                                'visible'=> ( str_contains( $gridViewVisibility["reason-view"], 'true' ) == "true" && User::hasPermission("report-result-view") ) ? true : false,
                                'format'=>'raw',
                                'options'=>['style'=>'width:15%;text-align:center;'],
                                'headerOptions' => ['style' => 'width:15%;text-align:center;'],
                                'contentOptions' => ['style' => 'width:15%;text-align:center;'],
                            ...
                            [
                                ...
                                'visible'=> ( str_contains( $gridViewVisibility["reported_at-view"], 'true' ) == "true" && User::hasPermission("report-created-view") ) ? true : false,
                                'options'=>['style'=>'width:10%;text-align:center;'],
                                'headerOptions' => ['style' => 'width:10%;text-align:center;'],
                                'contentOptions' => ['style' => 'width:10%;text-align:center;'],
                            ...
                            'visible'=> ( str_contains( $gridViewVisibility["status-view"], 'true' ) == "true" && User::hasPermission("report-status-view") ) ? true : false,
                            'filter' => false,
                            'options'=>['style'=>'width:10%;text-align:center;'],
                            'headerOptions' => ['style' => 'width:10%;text-align:center;'],
                            'contentOptions' => ['style' => 'width:10%;text-align:center;'],
                            ...
                            [
                                ...
                                'visible'=>User::canRoute("/user-damages/update"),
                            ...
                            [
                                'class' => 'yii\grid\ActionColumn',
                                'visible'=>User::canRoute("/user-damages/delete"),
...
#reports-grid-clear-filters-btn{
    margin-right: 20px;
}
</style>
