...
$this->registerJsFile('https://maps.googleapis.com/maps/api/js?key='.$siteConfig['google_map_js_token'].'&callback=initMap', ['depends' => [yii\web\JqueryAsset::className()]]);
...
<div class="row">
	<div class="col-sm-12 col-lg-12">
            <?php $form = ActiveForm::begin([
                    ...
                    'validationUrl' => $langUrl.'/request-order/add-cordinate-validate?id='.$model->id,
		        ...
		        <div id='map'></div>
    	        <div class="form-group">
    	            <?= Html::submitButton(Yii::t('app','Save cordinate'), ['class' => 'btn btn-primary']) ?>
    	        </div> 
		<?php ActiveForm::end(); ?>
	</div>
</div>
