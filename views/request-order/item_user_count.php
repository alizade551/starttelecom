...
<div class="row">
	<div class="col-sm-12">
		...
		<?php $form = ActiveForm::begin([
		    ...
		    'validationUrl' => $langUrl .'/request-order/add-item-to-user-validate',
					...
					'pluginOptions' => [
			          ...
			          'pluginEvents'=>["change" => "function() { 
			              var that = $(this);
			                  ...
			                  $.pjax.reload({
			                  url:'".$langUrl.Url::to('/request-order/add-item-to-user')."?id=".Yii::$app->request->get("id")."&item_id='+that.val(),
...
xhr_active_item=true;
 ...
 xhr_item = $.ajax({
      url: "'.\yii\helpers\Url::to(["request-order/add-item-to-user?id="]).Yii::$app->request->get("id").'",
      type: "post",
      beforeSend:function(){
          $(".loader").show();
          $(".overlay").addClass("show");
