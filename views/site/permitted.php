...
$this->title = Yii::t('app','Permitted users');
 ?>
                    ...
                    <tbody>
                    	...
                    	<?php foreach ($model as $userKey => $user): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td><div class="td-content"><span class="discount-pricing"><a data-pjax="0" href="/users/view?id=<?=$user['id'] ?>"><?= $user['fullname'] ?></a></span></div></td>
	                        </tr>
...
<?php 
Modal::begin([
    'title' =>Yii::t("app","Permitted users"),
    'id' => 'modal',
    'options' => [
