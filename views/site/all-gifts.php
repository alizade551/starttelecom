...
$this->title = Yii::t('app','All gifts');
 ?>
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item parent"><a  href="/"><?=Yii::t('app','Home') ?></a></li>
                    ...
                    <tbody>
                    	...
                    	<?php foreach ($model as $userKey => $user): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td><div class="td-content"><span class="discount-pricing"><a data-pjax="0" href="/users/view?id=<?=$user['user_id'] ?>"><?= $user['usern_name'] ?></a></span></div></td>
	                        </tr>
                    	<?php endforeach ?>
                    </tbody>
                </table>
