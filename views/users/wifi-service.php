...
$service_id = Yii::$app->request->get("service_id");
 ?>
 <div class="wifi-form panel panel-default " style="padding: 10px;width: 100%">
<?php if (count($model_packets) != 0): ?>
	


    <?php $form = ActiveForm::begin(['options' => ['id'=>'wifi-service-form']]); ?>
...
var form = $("form#wifi-service-form");
...
return false;
     ...
     xhr = $.ajax({
          url: "'.\yii\helpers\Url::to(["wifi-service"]).'"+"?id='.$id.'"+"&service_id='.$service_id.'",
          type: "post",
          data: form.serialize(),
